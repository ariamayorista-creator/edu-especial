  ...
  return (
    <div className="p-4 pb-32">
      <div className="flex items-center gap-4 mb-8 pt-8">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900 dark:text-white">PPI</h1>
          <p className="text-slate-500 dark:text-slate-400 text-xs font-medium">Proyecto Pedagógico Individual</p>
        </div>
      </div>
